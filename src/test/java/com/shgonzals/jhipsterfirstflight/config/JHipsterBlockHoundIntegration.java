...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.shgonzals.jhipsterfirstflight.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.shgonzals.jhipsterfirstflight.security.DomainUserDetailsService", "createSpringSecurityUser");
